...
export function dateToString(epochDate, language) {
    ...
    const date = currentDateTime.toLocaleDateString(standardLanguageTag, dateOptions);
    const time = currentDateTime.toLocaleTimeString(standardLanguageTag, timeOptions);
